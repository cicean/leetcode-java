...
public class FrogJump {
    ...
    /**
     * Use map to represent a mapping from the stone (not index)
     * to the steps that can be taken from this stone.
     ...
     {17=[], 0=[1], 1=[1, 2], 3=[1, 2, 3], 5=[1, 2, 3], 6=[1, 2, 3, 4],
     8=[1, 2, 3, 4], 12=[3, 4, 5]}

     Notice that no need to calculate the last stone.

     On each step, we look if any other stone can be reached from it, if so,
     we update that stone's steps by adding step, step + 1, step - 1.
     If we can reach the final stone,
     we return true. No need to calculate to the last stone.
     */
