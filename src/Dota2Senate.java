...
public class Dota2Senate {
  ...
  /**
   * This is obliviously a greedy algorithm problem. Each senate R must ban its next closest senate
   * D who is from another party, or else D will ban its next senate from R's party.
