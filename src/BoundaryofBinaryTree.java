...
public class BoundaryofBinaryTree {
  ...
  //We perform a single preorder traversal of the tree, keeping tracking of the left boundary and
  // middle leaf nodes and the right boundary nodes in the process. A single flag is used to designate
  // the type of node during the preorder traversal. Its values are:
